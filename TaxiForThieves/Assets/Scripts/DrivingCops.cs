...
public class DrivingCops : MonoBehaviour
{
    #region Fields
    private float speed;
    private float speedMax = 5f;
    private float speedMin = -2.5f;
    private float acceleration = 20f;
    private float brakeSpeed = 200f;
    private float reverseSpeed = 3f;
    private float idleSlowdown = 20f;

    private float turnSpeed;
    private float turnSpeedMax = 10f;
    private float turnSpeedAcceleration = 20f;
    private float turnIdleSlowdown = 50f;
